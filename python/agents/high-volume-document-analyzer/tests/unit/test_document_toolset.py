...
from high_volume_document_analyzer.tools.document_toolset import analyze_document_next_chunk
...
async def test_analyze_document_reset_search(mock_tool_context):
    ...
    with patch("high_volume_document_analyzer.tools.document_toolset.fetch_document_urls_async", new_callable=AsyncMock) as mock_fetch:
